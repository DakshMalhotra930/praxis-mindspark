...
-- Content indexes
CREATE INDEX idx_generated_content_user_subject ON public.generated_content(user_id, subject);
CREATE INDEX idx_generated_content_topic ON public.generated_content(subject, chapter, topic);
...
CREATE INDEX idx_daily_usage_feature ON public.daily_usage(feature_name);
CREATE INDEX idx_activity_logs_user ON public.activity_logs(user_id);
CREATE INDEX idx_activity_logs_action ON public.activity_logs(action);

-- Study progress indexes
CREATE INDEX idx_study_progress_user ON public.study_progress(user_id);
CREATE INDEX idx_study_progress_subject ON public.study_progress(subject, chapter);
CREATE INDEX idx_study_progress_last_studied ON public.study_progress(last_studied);

-- Quiz indexes
CREATE INDEX idx_quiz_sessions_user ON public.quiz_sessions(user_id);
CREATE INDEX idx_quiz_sessions_subject ON public.quiz_sessions(subject, chapter, topic);
CREATE INDEX idx_quiz_questions_session ON public.quiz_questions(session_id);

-- System monitoring indexes
CREATE INDEX idx_health_logs_service ON public.health_logs(service_name);
CREATE INDEX idx_health_logs_created ON public.health_logs(created_at);
